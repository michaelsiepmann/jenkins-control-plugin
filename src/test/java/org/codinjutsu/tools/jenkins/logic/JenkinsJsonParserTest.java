...
public class JenkinsJsonParserTest {
    ...
    public void loadJenkinsWorkSpace() throws Exception {
        ...
        Collection<View> actualViews = jenkins.getViews();
    ...
    public void loadClassicView() throws Exception {
        ...
        expectedJobs.add(new JobBuilder().job("sql-tools", "blue", "http://myjenkins/job/sql-tools/", "true", "true")
                .lastBuild("http://myjenkins/job/sql-tools/15/", "15", SUCCESS.getStatus(), "false", 1477640156281L, 4386421L)
        ...
        expectedJobs.add(new JobBuilder().job("myapp", "red", "http://myjenkins/job/myapp/", "false", "true")
                .lastBuild("http://myjenkins/job/myapp/12/", "12", FAILURE.getStatus(), "true", 1477640156281L, 4386421L)
        ...
        expectedJobs.add(new JobBuilder().job("swing-utils", "disabled", "http://myjenkins/job/swing-utils/", "true", "false")
                .lastBuild("http://myjenkins/job/swing-utils/5/", "5", FAILURE.getStatus(), "false", 1477640156281L, 4386421L)
...
//        assertReflectionEquals(expectedJobs, actualJobs); TODO create real object for assertions
    ...
    public void testLoadJob() throws Exception {
        ...
        assertReflectionEquals(new JobBuilder()
                ...
                .lastBuild("http://ci.jenkins-ci.org/job/config-provider-model/8/", "8", "SUCCESS", "false", 1477640156281L, 4386421L)
    ...
    public void testBugWithNullLastBuildAndEmptyHealthReport() throws Exception {
        ...
        List<Job> expectedJobs = Arrays.asList(
                new JobBuilder()
                        ...
                        .lastBuild("http://jenkins.home.lobach.info:8080/job/abris/80/", "80", "SUCCESS", "false", 1477640156281L, 4386421L)
                ...
                new JobBuilder()
                        ...
                        .lastBuild("http://jenkins.home.lobach.info:8080/job/zfImageFilter/14/", "14", "SUCCESS", "false", 1477640156281L, 4386421L)
    ...
    public void testBugWithManyParameters() throws Exception {
        ...
        List<Job> expectedJobs = Collections.singletonList(
                new JobBuilder()
                        ...
                        .lastBuild("http://localhost:8484/jenkins/job/DummyProject/26/", "26", "FAILURE", "false", 1477640156281L, 4386421L)
